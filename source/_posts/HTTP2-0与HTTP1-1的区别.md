...
categories:
  - gallery
date: 2022-07-16 17:07:55
---

1. ## 什么是HTTP2.0

- HTTP/2（超文本传输协议第二版，最初命名为HTTP2.0），是HTTP协议的第二个主要版本，使用于万维网。HTTP/2是HTTP协议自1999年HTTP1.1发布后的首个更新，主要基于SPDY协议(是Google开发的基于TCP的应用层协议，用以最小化网络延迟，提升网络速度，优化用户的网络使用体验)。
...
- 使用报头压缩，HTTP/2降低了开销
- HTTP/2让服务器可以响应主动“推送”到客户端缓存中

3. ## HTTP/2为什么是二进制

- 二进制解析起来更加高效、“线上”更紧凑，更重要的是错误更少
